...
#! @Arguments dir, K, n
DeclareOperation( "KroneckerAlgebra", [ IsDirection, IsField, IsInt ] );
#! @Arguments K, n
DeclareOperation( "LeftKroneckerAlgebra", [ IsField, IsInt] );
#! @Arguments K, n
DeclareOperation( "RightKroneckerAlgebra", [ IsField, IsInt ] );
#! @EndGroup
...
#! @Returns <Ref Filt="IsQuiverAlgebra"/>
#! @Arguments K, Q, n
DeclareOperation( "TruncatedPathAlgebra", [ IsField, IsQuiver, IsInt ] );
